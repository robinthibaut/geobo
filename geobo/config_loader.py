...
xvoxsize = xLcube / xNcube * 1.0  # size of one voxel in meters
yvoxsize = yLcube / yNcube * 1.0  # size of one voxel in meters
zvoxsize = zLcube / zNcube * 1.0  # size of one voxel in meters
